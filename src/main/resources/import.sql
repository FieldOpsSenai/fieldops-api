...
INSERT INTO usuarios (nome, email, senha, perfil, ativo) VALUES ('Admin', 'admin@fieldops.com', '$2a$10$Y50UaMFOxteibQEYLrwuHeehHYfcoPX9KERudcOH.55Y5.oEqaCIq', 'ADMINISTRADOR', true);
INSERT INTO usuarios (nome, email, senha, perfil, ativo) VALUES ('Carlos Tecnico', 'tecnico@fieldops.com', '$2a$10$Y50UaMFOxteibQEYLrwuHeehHYfcoPX9KERudcOH.55Y5.oEqaCIq', 'TECNICO', true);
